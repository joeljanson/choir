...
export class Ball {
	...
	checkBoundaryCollision() {
		if (this.position.x > this.w - this.r) {
			this.position.x = this.w - this.r;
			this.velocity.x *= -1;
		...
		} else if (this.position.y > this.h - this.r) {
			this.position.y = this.h - this.r;
			this.velocity.y *= -1;
	...
	checkCollision(other) {
		...
		if (distanceVectMag < minDistance) {
			...
			//Has to be converted if anglemode is degrees!!
