...
class DroneGrainPlayer extends GrainPlayer {
	constructor(options) {
		super(options);
	...
	updateScrubPosition(position) {
		...
		this.loopEnd = Math.max(Math.min(position + 0.05, this.buffer.duration), 0);
		//console.log("this.loopStart: ", this.loopStart);
		//console.log("this.loopEnd: ", this.loopEnd);
	}
}

export default DroneGrainPlayer;
